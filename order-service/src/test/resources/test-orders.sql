...
insert into orders (id,order_number,username,
                    ...
                    status,comments) values
                                         (1, 'order-123', 'geovanny', 'Geovanny', 'geovanny@gmail.com', '11111111', '123 Main St', 'Apt 1', 'Dallas', 'TX', '75001', 'USA', 'NEW', null),
                                         (2, 'order-456', 'geovanny', 'Elena', 'elena@gmail.com', '2222222', '123 Main St', 'Apt 1', 'Hyderabad', 'TS', '500072', 'India', 'NEW', null)
;
