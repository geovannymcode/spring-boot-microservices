...
import com.geovannycode.notifications.AbstractIT;
import com.geovannycode.notifications.ApplicationProperties;
import com.geovannycode.notifications.domain.models.Address;
import com.geovannycode.notifications.domain.models.Customer;
import com.geovannycode.notifications.domain.models.OrderCancelledEvent;
import com.geovannycode.notifications.domain.models.OrderCreatedEvent;
import com.geovannycode.notifications.domain.models.OrderDeliveredEvent;
import com.geovannycode.notifications.domain.models.OrderErrorEvent;
...
public class OrderEventHandlerTests extends AbstractIT {
    ...
    Customer customer = new Customer("Geovanny", "geovanny@gmail.com", "999999999");
    Address address = new Address("addr line 1", null, "Barranquilla", "ATL", "500072", "Colombia");
